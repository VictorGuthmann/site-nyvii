...
export default function Header() {
  ...
  return (
    <header
      className={`${isScrolled && "bg-[#ff00fa] text-white"}
     fixed top-0 z-50
     flex w-full items-center justify-between bg-gradient-to-t from-transparent to-pink-500 p-2 px-4 transition-all lg:px-16 lg:py-4`}
    >
